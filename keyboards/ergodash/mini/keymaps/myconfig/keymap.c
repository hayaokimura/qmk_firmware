...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_ESC, KC_LALT, KC_LGUI, KC_LGUI,             LOWER,   KC_SPC , KC_LSFT,        KC_BSPC,KC_ENT , RAISE,            KC_LEFT, KC_DOWN, KC_UP, KC_RGHT    \
  ),
   ...
   * |   ~  |   1  |   2  |   3  |   4  |   5  |   {  |                    |   }  |   6  |   7  |   8  |   9  |   0  |  "   |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift| Space| Left | Down |  Up  | Right|   :  |                    | Enter|   N  |   M  |   <  |   >  |   ?  | Shift|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_LSFT, KC_SPC , KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_COLN,                        KC_ENT , KC_N,    KC_M,    KC_LT,   KC_GT,   KC_QUES, KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             LOWER,   KC_SPC , KC_LSFT,        KC_BSPC,KC_ENT , RAISE,            KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
  ),
  ...
  */
  [_RAISE] = LAYOUT(
    ...
    KC_LCTL, KC_F11 , KC_F12,  EISU,             LOWER,   KC_SPC , KC_LSFT,        KC_BSPC,KC_ENT , RAISE,            KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
    ),
